...
class _MultiGradeBookPageState extends State<MultiGradeBookPage> {
  ...
  Color _getColorForGrade(int grade) {
    switch (grade) {
      ...
      case 1: return const Color.fromARGB(255, 152, 41, 33);
      default: return Colors.red;
    }
  }

  void _showAddGradeDialog(String studentName, String dateKey) {
  final selectedGrade = ValueNotifier<int>(4);
        ...
        return AlertDialog(
          ...
          content: DropdownButton<int>(
            ...
            items: [1, 2, 3, 4, 5]
                ...
                .toList(),
            onChanged: (value) => selectedGrade.value = value ?? 4,
          ),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              onPressed: () {
                _addGrade(studentName, dateKey, grade);
                Navigator.pop(ctx);
              },
